...
- سورس ماتريكس V5
- ملف صانعة بتعبي لتصير مو خوش ولد وتخمط حب
- اقوة بوت بالتليجرام
--]]
  ...
  if database:get('bot:tgservice:mute'..msg.chat_id_) then
   ...
   function get_welcome(extra,result,success)
    if database:get('welcome:'..msg.chat_id_) then
        ...
        text = 'اهلا بك في المجموعه عزيزي 🔹{firstname} 🍄 تابع جديدنا في التطوير @team_matrix 👁‍🗨 @mest_ar'
    end
...
if text == 'مستر' then
if not database:get('bot:rep:mute'..msg.chat_id_) then
faeder = "شِٰـِۢتِٰـِۢريِٰـِۢد مِٰـِۢنِٰـِۢة حِٰـِۢبِٰـِۢيِٰـِۢ ڪِٰـِۢلِٰـِۢيِٰـِۢ ﯛ̲୭آنِٰـِۢيِٰـِۢ آﯛ̲୭صِٰـِۢلِٰـِۢة مِٰـِۢسِٰـِۢتِٰـِۢر فِٰـِۢديِٰـِۢتِٰـِۢة ♛⇣🐰☄️₎✦"
else
faeder = ''
end
send(msg.chat_id_, msg.id_, 1, faeder, 1, 'md')
...
if text == 'بوت' then
if not database:get('bot:rep:mute'..msg.chat_id_) then
faeder = "اٰسٰـہٰٖمٰـہٰٖيٰـہٰٖ مٰـہٰٖاٰتٰـہٰٖرٰكٰـہٰٖسٰـہٰٖ 卍🔰⁽ 🌝☄️"
else
faeder = ''
end
send(msg.chat_id_, msg.id_, 1, faeder, 1, 'md')
...
if not database:get('bot:rep:mute'..msg.chat_id_) then
faeder =  "- رٰاٰسٰـہٰٖلـہٰٖ اٰلـہٰٖمٰـہٰٖطٰـہٰٖوٰرٰ ║♜💛⚡️₎⇣✿  @sl00ls"
else
faeder = ''
end
send(msg.chat_id_, msg.id_, 1, faeder, 1, 'md')
...
if text:match("^رجلي$") then
                ...
                send(msg.chat_id_, msg.id_, 1, '🔹رقم الشاصي : '..msg.sender_user_id_..'\n🔋نوع رجلك : '..t, 1, 'md')
              end
  -----------------------------------------by maistar--------------------------------------------------------------
...
sendContact(msg.chat_id_, msg.id_, 0, 1, nil, (nkeko or 9647712024128), (nakeko or "مستر @sl00ls"), "", bot_id)
end
------------------------------by maistar---------------------------------------------------------------------
if text:match("^[Gg][Rr][Oo][Uu][Pp][Ss]$") and is_admin(msg.sender_user_id_, msg.chat_id_) or text:match("^المجموعات$") and is_admin(msg.sender_user_id_, msg.chat_id_) then
 ...
 local users = database:scard("bot:userss")
    local allmgs = database:get("bot:allmsgs")
      ...
      send(msg.chat_id_, msg.id_, 1, '🔘 - عدد المجموعات هي 🚧 ┇ *'..gps..'*', 1, 'md')
end
 end
